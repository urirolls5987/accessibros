document.addEventListener("DOMContentLoaded", function () {
  ...
  var r = document.querySelector('.asw-menu-content');
  r.innerHTML = `<div class="asw-card" style="margin-top: 15px;">
    <div class="asw-card-title"> Content Adjustments </div>
    <div class="asw-adjust-font">
      <div class="label">
        <span class="material-icons" style="margin-right:8px;">format_size</span> Adjust Font Size
      </div>
      <div>
  ...
  var f = function (s) {
    ...
    a.classList.contains("asw-filter")
      ? (document.querySelectorAll(".asw-filter").forEach(function (t) {t.classList.remove("asw-selected"),
  ...
  let m = document.querySelector(".asw-menu"),
    g = document.querySelector(".asw-overlay");
  document.querySelector(".asw-menu-btn").addEventListener(
    "click",
    function () {
  ...
  m.querySelectorAll(".asw-btn").forEach(function (t) {
    t.addEventListener("click", f, false);
  });
  m
  ...
  const styles = `
    ...
    .asw-menu-btn svg{width:34px;height:34px;min-height:34px;min-width:34px;max-width:34px;max-height:34px;background:0 0!important}
    ...
    .asw-menu-content{overflow:scroll;max-height:calc(100% - 80px);color:#000}
